...
export const ROLE_PERMISSIONS: Record<UserRole, string[]> = {
  ...
  RRHH: [
    ...
    "/recupero/importar",
    "/recupero/rutas",
    "/recupero/rutas/configuracion",
    "/recupero/rutas/importar",
    "/remanufactura",
    "/remanufactura/reportes",
    "/remanufactura/importar",
    "/remanufactura/mrp",
    "/remanufactura/mrp/datos-maestros",
    "/remanufactura/mrp/planificacion",
